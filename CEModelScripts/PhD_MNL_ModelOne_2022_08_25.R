...
### Set core controls
apollo_control = list(
  modelName       = "PhD_MNL_ModelOne_2022_08_25",
  modelDescr      = "PhD_MNL_ModelOne_2022_08_25",
  indivID         = "ID"
)
...
PhD_MNL_ModelOne_2022_08_25 = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

## Model output and results here alongside saving information
apollo_modelOutput(PhD_MNL_ModelOne_2022_08_25,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(PhD_MNL_ModelOne_2022_08_25,saveOutput_settings = list(printPVal=TRUE))
# saveRDS(PhD_MNL_ModelOne_2022_08_25, file="PhD_MNL_ModelOne_2022_08_25.rds")
