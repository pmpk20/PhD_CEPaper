...
paste0("The proportion of respondents who always chose the status quo Option A was ",
       18,
       "% (N = ",
       127,
       "),",
       "which was higher amongst those with low confidence <3/5 ",
       "(",
       26,
       "%, N = ",
       83,
       ")",
       "than higher confidence >3/5 ",
       "(",
       12,
       "%, N = ",
       44,
       ").,",
       "Conversely, the proportion of respondents who always chose option B varied with confidence in experts; ",
       23,
       "% ",
       "of those with confidence <3/5 (N = ",
       73,
       ") versus ",
       36,
       "% of those with confidence >3/5 (N = ",
