#### Experts: Entropy Balancing Weights For Experts ####
## Function: Weights the sample and estimates treatment effects
## Author: Dr Peter King (p.m.king@kent.ac.uk)
## Last change: 12/12/2022
## Notes:
# - This needs a lot of work to format like the table in-text
...
TableB1 %>%
  fwrite(
    sep = ",",
    here("Output/Tables", "TableB1_BalancingComparisons.txt"),
    row.names = TRUE,
    quote = FALSE
  )
