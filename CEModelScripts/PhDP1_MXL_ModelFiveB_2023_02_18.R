...
### Set core controls
apollo_control = list(
  modelName       = "PhD_MXL_ModelFiveB_2023_02_18",
  modelDescr      = "PhD_MXL_ModelFiveB_2023_02_18",
  indivID         = "ID",
  mixing=TRUE,
  nCores=10,
  outputDirectory="Output/ModelFiveB"
)
...
PhD_MXL_ModelFiveB_2023_02_18 = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

## Model output and results here alongside saving information
apollo_modelOutput(PhD_MXL_ModelFiveB_2023_02_18,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(PhD_MXL_ModelFiveB_2023_02_18,saveOutput_settings = list(printPVal=TRUE))
# saveRDS(PhD_MXL_ModelFiveB_2023_02_18, file="PhD_MXL_ModelFiveB_2023_02_18.rds")
...
Model <- readRDS(
  here("Output/ModelFiveB",
       "PhD_MXL_ModelFiveB_2023_02_18_model.rds")) ## Enter model of interest RDS here


# Conditionals: *****************************
PhD_MXL_ModelFiveB_2023_02_18_WTP <- apollo_conditionals(Model,apollo_probabilities,apollo_inputs )
PhD_MXL_ModelFiveB_2023_02_18_WTP %>%
  data.frame() %>%
  fwrite(sep=",",
         here("Output/ModelFiveB",
...
# Unconditionals: *****************************
PhD_MXL_ModelFiveB_2023_02_18_UCWTP <- apollo_unconditionals(Model,apollo_probabilities,apollo_inputs )
PhD_MXL_ModelFiveB_2023_02_18_UCWTP %>%
  data.frame() %>%
  fwrite(sep=",",
         here("Output/ModelFiveB",
              "PhD_MXL_ModelFiveB_2023_02_18_UCWTP.csv"))
