...
## TODO: Format nicely
# - Can we also change to match Figure 2?
# Figure B2. Frequency of choosing either option A or B
# (scale of the Y axis is variable between facets)
# by self-reported confidence in experts (X axis)
# with facets drawn for each of the three levels of stated choice certainty.
# Boxplots with median indicated by horizontal black line,
# box edges represent interquartile range,
# and error bars drawn to 95% confidence intervals.
# Missing error bars present for small subsamples.
...
ggsave(
  FigureB2,
  device = "png",
  filename = here("Output/Plots", "FigureB2_ChoiceCertaintyFacet.png"),
  width = 25,
  height = 15,
  units = "cm",
  dpi = 500
